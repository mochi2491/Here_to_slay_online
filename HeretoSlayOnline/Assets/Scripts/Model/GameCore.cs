...
[System.Serializable]
public class SendTextEvent : UnityEvent<string> {
} //SendTextを子クラスに渡すためのクラス

[System.Serializable]
public class ChangeStateEvent : UnityEvent<GameState> {
...
public class Entrance : MonoBehaviour, IEntrance {
    private SendTextEvent sendText; //textを送信するためのEvent
    private ChangeStateEvent changeState; //GameCoreのstateを変更するためのEvent
